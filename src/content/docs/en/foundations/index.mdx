...
description: 'A developer-focused, zero-to-hero course on Terraform and Terragrunt targeting Microsoft Azure — HCL, state, variables and modules, multi-environment design, Terragrunt, and running infrastructure as code in production.'
sidebar:
  order: 1
---
...
Terraform is **declarative infrastructure as code**: you describe desired Azure resources in HCL, and Terraform plans and applies the changes needed to get there, tracking everything in **state**. This course teaches Terraform and Terragrunt from a developer's seat — the workflow, the guarantees, and the production behavior — starting from HCL itself.
</Callout>
