...
description: 'Why every real Terraform setup on Azure needs more than one environment, and why copy-pasting a directory per environment quietly falls apart over time.'
sidebar:
  order: 1
---
...
export const quizMultiEnvProblem = [
  {
    ...
    options: [
      ...
      'Copy-pasting directories is not allowed by the azurerm provider',
  ...
  },
  {
    ...
    options: [
      ...
      'Azure periodically changes resource defaults on its own',
  ...
  },
  {
    ...
    options: [
      ...
      'Limiting how far a mistake, bad apply, or leaked credential in one environment can actually reach, often by placing environments in separate Azure resource groups or subscriptions',
