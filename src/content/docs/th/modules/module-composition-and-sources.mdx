...
export const quizModuleComposition = [
  ...
  {
    q: 'module vnet ในตัวอย่างนี้ต้องรู้หรือไม่ว่าจะมี virtual-machine module มา consume output ของตัวเอง',
    options: [
      ...
      'ต้องรู้ Terraform บังคับให้ module ประกาศว่า module ไหนจะ consume output ของตัวเองได้บ้าง',
