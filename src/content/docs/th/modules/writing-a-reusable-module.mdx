...
export const quizWritingReusableModule = [
  ...
  },
  {
    ...
    options: [
      ...
      'เพราะ caller แต่ละคนต้องการชื่อ storage account ที่ต่างกันจริง ๆ โดยไม่มี default ที่สมเหตุสมผล ส่วน caller ส่วนใหญ่พอใจกับ behavior เดิมของ account_replication_type',
