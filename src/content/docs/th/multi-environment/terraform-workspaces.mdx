...
export const quizWorkspaces = [
  {
    ...
    options: [
      ...
      'state file แยกต่างหาก ส่วน backend configuration, provider configuration, และ .tf code ยังคงแชร์กันอยู่',
