...
description: 'การให้แต่ละ environment มี directory, backend, และ provider block ของตัวเองให้ isolation จริงบน Azure ยังไง และปัญหา duplication ใหม่ที่ตามมา'
sidebar:
  order: 3
---
...
export const quizDirPerEnv = [
  {
    ...
    options: [
      'ทำให้ไม่ต้องมี Terraform state file เลย',
      ...
      'ทำให้ทุก environment sync กันเองอัตโนมัติเสมอ',
      'ทำให้ไม่ต้องใช้ input variable เลย',
    ],
    answer: 1,
  },
  {
