...
export const quizSecretsCredentials = [
  ...
  },
  {
    ...
    options: [
      'มันกันค่า secret ไม่ให้เขียนลง state file ได้ทั้งหมด',
      'มัน centralize ว่าค่า secret จริงมาจากไหนและ rotate ที่ไหน แม้ค่าที่ resolve ได้จะยังไปจบลงใน state เหมือน resource attribute อยู่ดี',
      'data source ไม่ถูก cache ไว้ใน state ต่างจาก variable',
      'มันตัดความจำเป็นในการป้องกัน state backend ด้วย Azure RBAC ออกไปเลย',
    ],
    answer: 1,
  },
  {
